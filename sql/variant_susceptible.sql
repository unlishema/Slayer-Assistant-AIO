-- Insert into variant_susceptible or update if the link already exists
INSERT INTO variant_susceptible (variant_id, susceptible_id)
...
FROM all_variants v
JOIN all_creatures c ON c.id = v.creature_id
JOIN all_susceptible s ON s.link IN ('<a href="https://runescape.wiki/w/Dragon_slayer_(effect)" title="Dragon slayer (effect)" target="_blank"><img src="./images/susceptible/Dragon_Slayer_%28perk%29.png" decoding="async" loading="lazy" width="25" height="25"></a>')
...
FROM all_variants v
JOIN all_creatures c ON c.id = v.creature_id
JOIN all_susceptible s ON s.link IN ('<a href="https://runescape.wiki/w/Demon_slayer_(effect)" title="Demon slayer (effect)" target="_blank"><img src="./images/susceptible/Demon_Slayer_%28perk%29.png" decoding="async" loading="lazy" width="25" height="25"></a>')
...
FROM all_variants v
JOIN all_creatures c ON c.id = v.creature_id
JOIN all_susceptible s ON s.link IN ('<a href="https://runescape.wiki/w/Necklace_of_Salamancy" title="Necklace of Salamancy" target="_blank"><img src="./images/susceptible/Necklace_of_Salamancy.png" decoding="async" loading="lazy" width="25" height="22"></a>', '<a href="https://runescape.wiki/w/Undead_slayer_(effect)" title="Undead slayer (effect)" target="_blank"><img src="./images/susceptible/Undead_Slayer.png" decoding="async" loading="lazy" width="25" height="25"></a>')
WHERE c.name = 'Osseous' AND v.name = 'Default'
UNION ALL
SELECT v.id AS variant_id, s.id AS susceptible_id
FROM all_variants v
JOIN all_creatures c ON c.id = v.creature_id
JOIN all_susceptible s ON s.link IN ('<a href="https://runescape.wiki/w/Hexhunter_bow" title="Hexhunter bow" target="_blank"><img src="./images/susceptible/Hexhunter_bow.png" decoding="async" loading="lazy" width="25" height="26"></a>', '<a href="https://runescape.wiki/w/Necklace_of_Salamancy" title="Necklace of Salamancy" target="_blank"><img src="./images/susceptible/Necklace_of_Salamancy.png" decoding="async" loading="lazy" width="25" height="22"></a>')
...
FROM all_variants v
JOIN all_creatures c ON c.id = v.creature_id
JOIN all_susceptible s ON s.link IN ('<a href="https://runescape.wiki/w/Necklace_of_Salamancy" title="Necklace of Salamancy" target="_blank"><img src="./images/susceptible/Necklace_of_Salamancy.png" decoding="async" loading="lazy" width="25" height="22"></a>')
