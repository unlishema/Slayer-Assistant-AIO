...
public class ImageManager {
	...
	public void addMaster(final String name, final String url) {
		...
		this.masters
				.add(new Pair<File, String>(new File((name.startsWith("C:") ? "" : "images/masters/") + name), url));
	}
	...
	public void addWeakness(String name, final String url) {
		...
		this.weakness
				.add(new Pair<File, String>(new File((name.startsWith("C:") ? "" : "images/weakness/") + name), url));
	}
	...
	public void addSusceptible(String name, final String url) {
		...
		this.susceptible.add(
				new Pair<File, String>(new File((name.startsWith("C:") ? "" : "images/susceptible/") + name), url));
	}
	...
	public void addCreature(final String name, final String url) {
		...
		this.creatures
				.add(new Pair<File, String>(new File((name.startsWith("C:") ? "" : "images/creatures/") + name), url));
	}
	...
	public ArrayList<Pair<File, String>> getMisc() { return this.misc; }

	public ArrayList<Pair<File, String>> getMasters() { return this.masters; }

	public ArrayList<Pair<File, String>> getWeaknesses() { return this.weakness; }

	public ArrayList<Pair<File, String>> getSusceptibilities() { return this.susceptible; }

	public ArrayList<Pair<File, String>> getCreatures() { return this.creatures; }

	public boolean hasData() {
		return this.misc.size() > 0 || this.masters.size() > 0 || this.weakness.size() > 0
				|| this.susceptible.size() > 0 || this.creatures.size() > 0;
	}
}
