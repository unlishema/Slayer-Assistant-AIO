...
public class SAAssignmentPanel extends JPanel {
	...
	public SAAssignmentPanel() {
		...
		this.add(panelUpdateAssignment, new GridBagConstraints(0, fy++, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

		// ---- labelDefaultCreature ----
		final JLabel labelDefaultCreature = new JLabel();
		labelDefaultCreature.setText("Default Creature");
		this.add(labelDefaultCreature, new GridBagConstraints(0, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		// this.textFieldDefaultCreature.setEnabled(false);
		this.add(this.textFieldDefaultCreature, new GridBagConstraints(1, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		this.add(this.labelDefaultCount, new GridBagConstraints(2, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		...
		buttonSelectDefaultCreature.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 0) {
					final Assignment assignment = Main
							.getAssignment(Main.frame.panelAssignment.labelIndexName.getText());
					final Object[] possibilities = Util.buildDefaultCreaturesUniqueArrayList(assignment.creatures,
							Main.frame.panelAssignment.textFieldDefaultCreature.getText(),
							Main.frame.panelAssignment.listHiddenCreaturesModel);
					final String newDefaultCreature = (String) JOptionPane.showInputDialog(Main.frame,
					...
					if (newDefaultCreature != null) {
						final Assignment currentAssignment = Main
								.getAssignment(Main.frame.panelTasks.listSlayerAssignments.getSelectedValue());
					...
					final Object[] possibilities = Util.buildDefaultCreaturesUniqueArrayList(reaper.creatures,
							Main.frame.panelAssignment.textFieldDefaultCreature.getText()).toArray();
					final String newDefaultCreature = (String) JOptionPane.showInputDialog(Main.frame,
							"What Default Creature would you like to change to for \""
									+ Main.frame.panelTasks.listSlayerAssignments.getSelectedValue() + "\"",
							"Change Default Creature", JOptionPane.PLAIN_MESSAGE, null, possibilities, "");
					...
					// If you typed a Hidden Creature then add it
					if (newDefaultCreature != null) {
						final Reaper currentReaper = Main
								.getReaper(Main.frame.panelTasks.listReaperAssignments.getSelectedValue());
		...
		this.add(buttonSelectDefaultCreature, new GridBagConstraints(3, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

		// ---- labelAlias ----
		final JLabel labelAlias = new JLabel();
		labelAlias.setText("Aliases");
		this.add(labelAlias, new GridBagConstraints(0, fy++, 1, 3, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		this.add(scrollPaneAlias, new GridBagConstraints(1, fy, 2, 3, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		buttonAddAlias.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent ae) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 1) {
					JOptionPane.showMessageDialog(Main.frame, "Cannot add aliases to reaper at this time!",
							"Add New Alias", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				...
				final String alias = (String) JOptionPane.showInputDialog(
						Main.frame, "What Alias would you like to add to \""
								+ Main.frame.panelAssignment.labelIndexName.getText() + "\"",
						"Add New Alias", JOptionPane.PLAIN_MESSAGE, null, null, "");
		...
		this.add(buttonAddAlias, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		buttonEditAlias.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 1) {
					JOptionPane.showMessageDialog(Main.frame, "Cannot edit aliases in reaper at this time!",
							"Edit Alias", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if (Main.frame.panelAssignment.labelIndexName.getText() == null
						|| Main.frame.panelAssignment.labelIndexName.getText().equals("Example Assignment"))
				...
				if (Main.frame.panelAssignment.listAlias.getLastVisibleIndex() == -1) {
					JOptionPane.showMessageDialog(
							Main.frame, "There is no current Aliases for \""
									+ Main.frame.panelAssignment.labelIndexName.getText() + "\"",
							"Error Editing Alias", JOptionPane.ERROR_MESSAGE);
					return;
				}
				final String alias = (String) JOptionPane.showInputDialog(Main.frame,
						"What would you like to change \"" + Main.frame.panelAssignment.listAlias.getSelectedValue()
								+ "\" Alias to?",
						"Edit Alias", JOptionPane.PLAIN_MESSAGE, null, null,
						Main.frame.panelAssignment.listAlias.getSelectedValue());
		...
		this.add(buttonEditAlias, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		buttonDeleteAlias.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 1) {
					JOptionPane.showMessageDialog(Main.frame, "Cannot remove aliases from reaper at this time!",
							"Remove Alias", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if (Main.frame.panelAssignment.labelIndexName.getText() == null
						|| Main.frame.panelAssignment.labelIndexName.getText().equals("Example Assignment"))
				...
				final int result = JOptionPane.showConfirmDialog(Main.frame,
						"Are you sure you want the remove \"" + Main.frame.panelAssignment.listAlias.getSelectedValue()
		...
		this.add(buttonDeleteAlias, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

		// ---- labelHiddenCreature ----
		final JLabel labelHiddenCreature = new JLabel();
		labelHiddenCreature.setText("Hidden Creatures");
		this.add(labelHiddenCreature, new GridBagConstraints(0, fy, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		this.add(scrollPaneHiddenCreatures, new GridBagConstraints(1, fy, 2, 3, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		buttonAddHiddenCreature.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 1) {
					JOptionPane.showMessageDialog(Main.frame, "Cannot add hidden creatures to reaper at this time!",
							"Add New Hidden Creature", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if (Main.frame.panelAssignment.labelIndexName.getText() == null
						|| Main.frame.panelAssignment.labelIndexName.getText().equals("Example Assignment"))
				...
				final Object[] possibilities = Util.buildUniqueArrayList(assignment.creatures,
						Main.frame.panelAssignment.listHiddenCreaturesModel);
				final Creature hiddenCreature = (Creature) JOptionPane.showInputDialog(Main.frame,
						"What Hidden Creature would you like to add to \""
								+ Main.frame.panelAssignment.labelIndexName.getText() + "\"",
		...
		this.add(buttonAddHiddenCreature, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		buttonDeleteHiddenCreature.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				if (Main.frame.panelTasks.tabbedPaneAssignments.getSelectedIndex() == 1) {
					JOptionPane.showMessageDialog(Main.frame, "Cannot edit hidden creatures in reaper at this time!",
							"Edit Hidden Creature", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if (Main.frame.panelAssignment.labelIndexName.getText() == null
						|| Main.frame.panelAssignment.labelIndexName.getText().equals("Example Assignment"))
				...
				final int result = JOptionPane.showConfirmDialog(Main.frame,
						"Are you sure you want the remove \""
								+ Main.frame.panelAssignment.listHiddenCreatures.getSelectedValue()
				...
				case JOptionPane.YES_OPTION:
					...
					if (currentAssignment == null) break;
					currentAssignment
							.removeHiddenCreature(Main.frame.panelAssignment.listHiddenCreatures.getSelectedValue());
		...
		this.add(buttonDeleteHiddenCreature, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		this.add(this.labelHiddenCount, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		// ---- labelMasters ----
		final JLabel labelMasters = new JLabel();
		labelMasters.setText("Masters");
		this.add(labelMasters, new GridBagConstraints(0, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
		...
		this.add(scrollPaneMasters, new GridBagConstraints(1, fy++, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

		// ---- labelEquipment ----
		final JLabel labelEquipment = new JLabel();
		labelEquipment.setText("Equipment");
		this.add(labelEquipment, new GridBagConstraints(0, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
			...
			this.listEquipment.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent me) {
					...
					if (me.getClickCount() >= 2) {
						...
						if (currentEquipment != null) JOptionPane.showMessageDialog(Main.frame, currentEquipment,
								"Detailed Equipment", JOptionPane.INFORMATION_MESSAGE);
					}
				}
			});
			scrollPaneEquipment.setViewportView(this.listEquipment);
		}
		this.add(scrollPaneEquipment, new GridBagConstraints(1, fy++, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

		// ---- labelLocations ----
		final JLabel labelLocations = new JLabel();
		labelLocations.setText("Locations");
		this.add(labelLocations, new GridBagConstraints(0, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
			...
			this.listLocations.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent me) {
					...
					if (me.getClickCount() >= 2) {
						...
						if (currentLocation != null) JOptionPane.showMessageDialog(Main.frame, currentLocation,
								"Detailed Location", JOptionPane.INFORMATION_MESSAGE);
					}
				}
			});
			scrollPaneLocations.setViewportView(this.listLocations);
		}
		this.add(scrollPaneLocations, new GridBagConstraints(1, fy++, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

		// ---- labelCreatures ----
		final JLabel labelCreatures = new JLabel();
		labelCreatures.setText("Creatures");
		this.add(labelCreatures, new GridBagConstraints(0, fy, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		...
		final JScrollPane scrollPaneCreatures = new JScrollPane();
		{
			...
			this.listCreatures.addListSelectionListener(new ListSelectionListener() {
				...
				public void valueChanged(final ListSelectionEvent lse) {
					Main.frame.panelAssignment
							.selectCreature(Main.frame.panelAssignment.listCreatures.getSelectedValue());
				}
			});
			scrollPaneCreatures.setViewportView(this.listCreatures);
		}
		this.add(scrollPaneCreatures, new GridBagConstraints(1, fy++, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		...
		this.add(this.labelCreatureCount, new GridBagConstraints(3, fy++, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	}
	...
	public void selectCreature(final String name) {
		...
		// Select the current variant, default creature variant or the first creature in
		// list
		if (vName != null && !vName.isEmpty() && currentCreature.hasVariant(vName))
		...
		else if (a != null && a.defaultCreature != null && !a.defaultCreature.isEmpty()
				&& currentCreature.hasVariant(a.defaultCreature)) {
			...
			if (Main.frame.panelCreature.comboBoxVariants.getItemCount() > 0)
				Main.frame.panelCreature.comboBoxVariants.setSelectedIndex(0);
	}
}
