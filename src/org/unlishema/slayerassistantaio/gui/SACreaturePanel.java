...
public class SACreaturePanel extends JPanel {
	...
	// TODO Take into account the count for tasks from creatures (Like Greater
	// Demon Ash Lords count as 8 for task)
	...
	public SACreaturePanel() {
		...
		final JPanel panelVariantInfo = new JPanel();
		{
			...
			panelVariantInfo.add(buttonUpdateCreature, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
			...
			panelVariantInfo.add(this.labelCreatureName, new GridBagConstraints(1, 0, 2, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			...
			this.comboBoxVariants.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(final ItemEvent ie) {
					Main.frame.panelCreature.selectVariant(labelCreatureName.getText(),
							(String) comboBoxVariants.getSelectedItem());
				}
			});
			panelVariantInfo.add(this.comboBoxVariants, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			...
			panelVariantInfo.add(this.labelVariantCount, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			...
			panelVariantInfo.add(seperatorPanel, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		...
		final JPanel panelVariant = new JPanel();
		{
			...
			panelVariant.add(labelImage, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
			...
			panelVariant.add(this.panelImage, new GridBagConstraints(1, 0, 3, 2, 0.0, 0.0, GridBagConstraints.CENTER,
			...
			final JPanel panelExpStats = new JPanel();
			{
				...
				panelExpStats.add(labelExperienceStats, new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0,
				...
				panelExpStats.add(labelExperience, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelExperienceStat ----
				this.labelExperienceStat.setText("0000");
				panelExpStats.add(this.labelExperienceStat, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelExpStats.add(labelSlayerExp, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelSlayerExpStat ----
				this.labelSlayerExpStat.setText("0000");
				panelExpStats.add(this.labelSlayerExpStat, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelExpStats.add(labelLifepointExp, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
				...
				panelExpStats.add(this.labelLifepointExpStat, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			}
			panelVariant.add(panelExpStats, new GridBagConstraints(0, 2, 3, 4, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
...

			{
				...
				labelCombatStats.setFont(
						labelCombatStats.getFont().deriveFont(labelCombatStats.getFont().getStyle() | Font.BOLD));
				panelCombatStats.add(labelCombatStats, new GridBagConstraints(0, 0, 4, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelCombatStats.add(labelSlayerLevel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelSlayerLevelStat ----
				this.labelSlayerLevelStat.setText("000");
				panelCombatStats.add(this.labelSlayerLevelStat, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
				...
				panelCombatStats.add(labelLifepoints, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelLifepointsStat ----
				this.labelLifepointsStat.setText("0000000");
				panelCombatStats.add(this.labelLifepointsStat, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelCombatStats.add(labelLevel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));

				// ---- labelLevelStat ----
				this.labelLevelStat.setText("0000");
				panelCombatStats.add(this.labelLevelStat, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
				...
				panelCombatStats.add(labelDefence, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));

				// ---- labelDefenceStat ----
				this.labelDefenceStat.setText("00000");
				panelCombatStats.add(this.labelDefenceStat, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			}
			panelVariant.add(panelCombatStats, new GridBagConstraints(3, 2, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER,
			...
			final JPanel panelMaxStats = new JPanel();
			{
				...
				labelMaxStats
						.setFont(labelMaxStats.getFont().deriveFont(labelMaxStats.getFont().getStyle() | Font.BOLD));
				panelMaxStats.add(labelMaxStats, new GridBagConstraints(0, 0, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelMaxStats.add(labelMaxMelee, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelMaxMeleeStat ----
				this.labelMaxMeleeStat.setText("0000");
				panelMaxStats.add(this.labelMaxMeleeStat, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
				...
				panelMaxStats.add(labelMaxSpec, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));

				// ---- labelMaxSpecStat ----
				this.labelMaxSpecStat.setText("0000");
				panelMaxStats.add(this.labelMaxSpecStat, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));
				...
				panelMaxStats.add(labelMaxRanged, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));

				// ---- labelMaxRangedStat ----
				this.labelMaxRangedStat.setText("0000");
				panelMaxStats.add(this.labelMaxRangedStat, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
				...
				panelMaxStats.add(labelMaxMagic, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));

				// ---- labelMaxMagicStat ----
				this.labelMaxMagicStat.setText("0000");
				panelMaxStats.add(this.labelMaxMagicStat, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
			}
			panelVariant.add(panelMaxStats, new GridBagConstraints(3, 4, 1, 2, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

			// ---- labelSusceptible ----
			final JLabel labelSusceptible = new JLabel();
			labelSusceptible.setText("Susceptible");
			panelVariant.add(labelSusceptible, new GridBagConstraints(0, 6, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 5, 5), 0, 0));
				...
				this.listSusceptible.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(final MouseEvent me) {
						...
						if (me.getClickCount() >= 2) {
							...
							if (currentSusceptible != null) JOptionPane.showMessageDialog(Main.frame,
									currentSusceptible, "Detailed Susceptible", JOptionPane.INFORMATION_MESSAGE);
						}
					}
				});
				scrollPaneSusceptible.setViewportView(this.listSusceptible);
			}
			panelVariant.add(scrollPaneSusceptible, new GridBagConstraints(2, 6, 2, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 5, 0), 0, 0));

			// ---- labelWeakness ----
			final JLabel labelWeakness = new JLabel();
			labelWeakness.setText("Weakness");
			panelVariant.add(labelWeakness, new GridBagConstraints(0, 7, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0));
				...
				this.listWeakness.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(final MouseEvent me) {
						...
						if (me.getClickCount() >= 2) {
							...
							if (currentWeakness != null) JOptionPane.showMessageDialog(Main.frame, currentWeakness,
									"Detailed Weakness", JOptionPane.INFORMATION_MESSAGE);
						}
					}
				});
				scrollPaneWeakness.setViewportView(this.listWeakness);
			}
			panelVariant.add(scrollPaneWeakness, new GridBagConstraints(2, 7, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		}
	...
	public void selectVariant(final String name, final String variant) {
		...
		try {
			...
			if (imageFile.exists()) {
				...
				if (Util.DEBUG)
					System.err.println("[Images] " + currentCreature.name + "#" + cv.name + " image is missing!");
			}
		...
		for (final String sus : Util.sortArrayList(cv.susceptible))
			Main.frame.panelCreature.listSusceptibleModel.addElement(sus);
		for (final String weak : Util.sortArrayList(cv.weakness))
			Main.frame.panelCreature.listWeaknessModel.addElement(weak);
	}
}
